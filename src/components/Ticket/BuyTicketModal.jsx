...
const BuyTicketModal = ({ movie, visible, onClose, showtimes }) => {
  ...
  return (
    <>
      ...
      <Modal
        title={
          <p classNamw="text-xl font-semibold">BẠN ĐANG ĐẶT VÉ XEM PHIM</p>
        }
          ...
          <div className="flex justify-center items-center mt-4">
            {selectedShowTime && (
              <Link to={`/bookticket/${selectedShowTime.id}`}>
                <Button
                  className="text-white font-semibold text-lg bg-blue-500 pt-5 pb-5 pl-8 pr-8 flex justify-center items-center hover:bg-white"
                >
                  ĐỒNG Ý
                </Button>
              </Link>
